...
- 🎓 3rd-year CSE student at **IIIT Bhopal** (CGPA: 8.55/10.0)
- 🤖 Currently focused on **Agentic AI systems**, **RAG pipelines**, and **LLM-based applications**
- 🧠 Exploring LangGraph, LangChain, ChromaDB, and multi-provider LLM orchestration
- 🏆 320+ problems on Codeforces (Pupil), 250+ on LeetCode, 3-star on CodeChef
- 🏛️ Organizing team member, Competitive Programming Club @ IIIT Bhopal
- 🌱 Long-term goal: ML Engineer → PhD in AI/ML
